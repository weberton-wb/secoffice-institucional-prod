...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-40 right-20 w-6 h-6 border-2 border-primary hexagon-float opacity-30" style={{ animationDelay: '5s' }}></div>
      <div className="absolute bottom-40 left-20 w-10 h-10 border-2 border-primary hexagon-float opacity-20" style={{ animationDelay: '10s' }}></div>
